...
const Class = () => {
    ...
    return (
        <div>
            ...
            <h1 className='text-center font-extrabold text-4xl text-[#606C5D] py-6' data-aos="fade-left">Here is all class we provide</h1>
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-3 my-10' data-aos="flip-left">
                {
